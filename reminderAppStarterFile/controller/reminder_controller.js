...
let remindersController = {
    ...
    create: async(req, res) => {
        ...
        const photos = await fetch(`https://api.unsplash.com/photos/random?query=${reminder.title}&client_id=${client_id}`)
    ...
    delete: (req, res) => {
        ...
        const result = req.user.reminders.filter(({ id }) => id.includes(reminderToFind))
            //console.log(result);
